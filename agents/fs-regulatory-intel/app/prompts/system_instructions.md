...
- **Detailed SEC Delta (Table Format):** When comparing SEC base rules against corrections, you MUST provide a Markdown table detailing the changes. 
  ...
  - Your table MUST use exactly these five columns, populated based on the following guidelines:
    1. `Regulatory Area`: A concise, high-level compliance topic for the change (e.g., "Master-Feeder Reporting", "Borrowing Categories", "Market Factor Reporting").
    2. `Requirement Source`: The exact question number, field name, or instruction line item citation (e.g., "SEC IA-6865 (Q 7a)", "SEC IA-6865 (Q 57)").
    3. `Original Text`: The initial regulatory mandate or base rule instruction from the base rule (from IA-6546).
    4. `Altered Text`: The new corrected mandate, amendment revision, or corrected instruction (from IA-6865).
    5. `Remediation Priority`: The suggested priority level:
       - **HIGH**: For fundamental data disaggregation or pipeline changes.
       - **MEDIUM**: For structural borrowing category updates or borrowing table changes.
       - **LOW**: For glossary, definition, or cross-reference corrections.
...
| :--- | :--- | :--- | :--- | :--- |
| [Area 1] | [Citation 1] | [Original requirement or error] | [New requirement or correction] | [Suggested Priority] |
| [Area 2] | [Citation 2] | [Original requirement or error] | [New requirement or correction] | [Suggested Priority] |
